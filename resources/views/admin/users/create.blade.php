                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group {{ $errors->has('address_line1') ? 'has-error' : '' }}">
                                            ...
                                            <input type="text" id="address_line1" name="address_line1" class="form-control" value="{{ old('address_line1', isset($user) ? $user->address_line1 : '') }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {{ $errors->has('address_line2') ? 'has-error' : '' }}">
                                            ...
                                            <input type="text" id="address_line2" name="address_line2" class="form-control" value="{{ old('address_line2', isset($user) ? $user->address_line2 : '') }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {{ $errors->has('region') ? 'has-error' : '' }}">
                                            ...
                                            <input type="text" id="region" name="region" class="form-control" value="{{ old('region', isset($user) ? $user->region : '') }}">
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group {{ $errors->has('subscription_type_id') ? 'has-error' : '' }}">
                                            ...
                                            <select name="subscription_type_id" id="subscription_type_id" class="form-control">
                                                @foreach($subscriptionTypes as $id => $subscriptionTypes)
                                                    <option value="{{ $id }}" {{  isset($user) && $user->subscriptionType->contains($id) ? 'selected' : '' }}>
                                                        {{ $subscriptionTypes }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group {{ $errors->has('currency') ? 'has-error' : '' }}">
                                            ...
                                            <input type="text" id="currency" name="currency" class="form-control" value="{{ old('currency', isset($user) ? $user->currency : '') }}">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group {{ $errors->has('price') ? 'has-error' : '' }}">
                                            ...
                                            <input type="number" min="0" id="price" name="price" class="form-control" value="{{ old('price', isset($user) ? $user->price : '') }}">
                                            @if($errors->has('price'))
                                                <p class="help-block">
                                                    {{ $errors->first('price') }}
                                                </p>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group {{ $errors->has('start_date') ? 'has-error' : '' }}">
                                            ...
                                            <input type="date" id="start_date" name="start_date" class="form-control" value="{{ old('start_date', isset($user) ? $user->start_date : '') }}">
